...
///   `U+E0000` Tag block live. See [`is_invisible`] for the tables and for
...
/// deleted (the tables in [`is_invisible`], which is what closes the
/// trojan-source and zero-width classes), and every control character replaced
...
///
/// The predicate the sanitiser actually needs, and not one `char` exposes.
...
/// and used to walk straight through this boundary.
///
